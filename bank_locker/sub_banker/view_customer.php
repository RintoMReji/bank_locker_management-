...
<div class="form-grid mb-20">
  ...
  <div class="card">
    <div class="card-header">
      <h3 style="color:var(--teal);">👤 Customer Profile</h3>
  ...
  <div class="card">
    <div class="card-header">
      <h3 style="color:var(--teal);">🔒 Locker Allocations</h3>
    </div>
...
<div class="card">
  <div class="card-header">
    <h3 style="color:var(--teal);">👥 Joint Locker Facility (Joint Holders & Nominees Details)</h3>
  </div>
  <div class="table-responsive">
    <table>
      <thead>
        ...
        <tr>
          ...
          <td>
            <?php if($jm['type'] === 'joint_holder'): ?>
                <span class="badge" style="background:#ccfbf1; color:#0f766e;">Joint Holder</span>
            <?php else: ?>
